...
$.fn.xb_scroll = function(options)
{
	...
	var jqScrollBar= $("<div style='position:absolute;width:"+opts.barWidth+"px;top:"+opts.barOffTop+"px;right:"+opts.barOffRight+"px;border-radius: 5px;background: rgba(85,85,85,1);'></div>");
	...
	jqScrollBar.on("mousedown",function(ev){
		...
		jqScrollBar.css({"background":"rgba(100,100,100,1)"});
	...
	$(document).on("mouseup",function(ev){	
		...
		jqScrollBar.css({"background":"rgba(85,85,85,1)"});
		isS_B = false;	
	});	
