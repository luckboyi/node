	...
	$.movingBoxes = function(el, options){
		...
		base.init = function(){
			...
			base.$wrap = base.$window.parent() // mb-wrapper
				.prepend('<a class="mb-scrollButtons mb-left" href="javascript:;"></a>')
				.append('<a class="mb-scrollButtons mb-right"  href="javascript:;"></a><div class="mb-left-shadow"></div><div class="mb-right-shadow"></div>');
		...
		base.buildNav = function() {
			...
			if (o.buildNav && base.totalPanels > 1) {
				...
				base.$panels.filter(':not(.cloned)').each(function(i){
					j = i + 1;
					a = '<a class="mb-link mb-panel' + j + '" href="javascript:;"></a>';
					$a = $(a);
