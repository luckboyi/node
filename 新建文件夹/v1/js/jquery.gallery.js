	...
	$.Gallery.prototype= {
		...
		_layout				: function() {
			...
			if( this.support3d && this.supportTrans ) {
				...
				leftCSS 	= {
					'-webkit-transform'	: 'translateX(-230px) translateZ(-200px) rotateY(45deg)',
					'-moz-transform'	: 'translateX(-230px) translateZ(-200px) rotateY(45deg)',
					'-o-transform'		: 'translateX(-230px) translateZ(-200px) rotateY(45deg)',
					'-ms-transform'		: 'translateX(-230px) translateZ(-200px) rotateY(45deg)',
					'transform'			: 'translateX(-230px) translateZ(-200px) rotateY(45deg)'
				};
				...
				leftCSS 	= {
					'-webkit-transform'	: 'translate(-230px) scale(0.8)',
					'-moz-transform'	: 'translate(-230px) scale(0.8)',
					'-o-transform'		: 'translate(-230px) scale(0.8)',
					'-ms-transform'		: 'translate(-230px) scale(0.8)',
					'transform'			: 'translate(-230px) scale(0.8)'
				};
		...
		_getCoordinates: function( position ) {
			...
			if( this.support3d && this.supportTrans ) {
				...
				switch( position ) {
					case 'outleft':
						return {
							'-webkit-transform'	: 'translateX(-330px) translateZ(-300px) rotateY(45deg)',
							'-moz-transform'	: 'translateX(-330px) translateZ(-300px) rotateY(45deg)',
							'-o-transform'		: 'translateX(-330px) translateZ(-300px) rotateY(45deg)',
							'-ms-transform'		: 'translateX(-330px) translateZ(-300px) rotateY(45deg)',
							'transform'			: 'translateX(-330px) translateZ(-300px) rotateY(45deg)',
							'opacity'			: 0,
							'visibility'		: 'hidden'
						};
						break;
				...
				switch( position ) {
					case 'outleft':
						return {
							'-webkit-transform'	: 'translate(-330px) scale(0.7)',
							'-moz-transform'	: 'translate(-330px) scale(0.7)',
							'-o-transform'		: 'translate(-330px) scale(0.7)',
							'-ms-transform'		: 'translate(-330px) scale(0.7)',
							'transform'			: 'translate(-330px) scale(0.7)',
							'opacity'			: 0,
							'visibility'		: 'hidden'
						};
						break;
